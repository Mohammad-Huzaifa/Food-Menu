...
function filterButton() {
  ...
  const categoryItem= categories.map(function(item){
...
function displayMenuItem (menuItem) {
  ...
  displayMenu = displayMenu.join(''); // join('')(emoty brances) method is used to make all the element is one and make it look like HTML. empty braces will remove the commas which will be there at the end of every element
